...
function create () {
    ...
    this.player.setMaxVelocity(500).setFriction(800, 600).setPassive();

    this.cursors = this.input.keyboard.createCursorKeys();

    // this.textVelX = this.add.text(10, 10, '', { font: '16px Courier', fill: '#00ff00' }).setDepth(1).setScrollFactor(0);
    // this.textVelY = this.add.text(10, 25, '', { font: '16px Courier', fill: '#00ff00' }).setDepth(1).setScrollFactor(0);

    //  The miniCam is 400px wide, so can display the whole world at a zoom of 0.2
    this.minimap = this.cameras.add(690, 10, 100, 100).setZoom(0.5);
    this.minimap.setBackgroundColor(0x002244);
    this.minimap.setBounds(0, 0, 3200, 600);
    // this.minimap.scrollX = 1360;
    // this.minimap.scrollY = 260;
    // this.updateCameras();

    this.graphics1 = this.make.graphics(0, 0);
    // this.graphics1 = this.impact.graphics(0, 0);
    // this.graphics1 = this.impact.make.graphics(0, 0);
    // this.aSquareBMD = this.add.bitmapData(20, 20);
    // this.aSquareBMD.rect(0, 0, 20, 20, "rgba(255, 255, 100, 0.6)");

    // this.aSquare = this.impact.add.sprite(this.player.x-20, this.player.y, this.aSquareBMD);
}
...
function update (time, delta) {
    ...
    // this.textVelX.setText("vel x: "+this.player.vel.x);
    // this.textVelY.setText("vel y: "+this.player.vel.y);
...
function updateCameras() {
    ...
    this.minimap.scrollX = this.player.x - 48;
    this.minimap.scrollY = this.player.y - 48;
}
...
function createStarfield () {
    ...
    var rect = new Phaser.Geom.Rectangle(0, 0, 3200, 350);
    // rect.setBackgroundColor(0x220022);
...
function createLandscape () {
    ...
    landscape.lineStyle(5, 0x00ff00, 1);
